...
function progressive_chart($atts)
{
  ...
  <div>
    <canvas id="progressChart" width="653" height="570"></canvas>
  </div>
  <script type="text/javascript">
    ...
    // Define mock data
    const canvasHeight = 543;
    const canvasWidth = 653;
    ...
    const externalTooltipHandler = (context) => {
      ...
      if (tooltip.body) {
        ...
        bodyLines.forEach((body, i) => {
          ...
          th.style.margin = 0;
          th.style.padding = 0;
          if (isSmallScreen()) th.style.fontSize = "14px";
